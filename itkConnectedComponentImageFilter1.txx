/*=========================================================================
  ...
  Module:    $RCSfile: itkConnectedComponentImageFilter1.txx,v $
  Language:  C++
...
=========================================================================*/
#ifndef _itkConnectedComponentImageFilter1_txx
#define _itkConnectedComponentImageFilter1_txx
...
void
ConnectedComponentImageFilter1< TInputImage, TOutputImage >
    ...
    if (label != NumericTraits<OutputPixelType>::Zero)
      ...
      if (originalLabel == label)
        ...
        if (maxLabel == maxPossibleLabel)
          {
          itkWarningMacro(<< "ConnectedComponentImageFilter1::GenerateData: Number of labels exceeds number of available labels for the output type." );
          }
        else
          {
          ++maxLabel;
