...
=========================================================================*/
#ifndef __itkConnectedComponentImageFilter2_h
#define __itkConnectedComponentImageFilter2_h
...
class ITK_EXPORT ConnectedComponentImageFilter2 : 
...
public:
   ...
   */
  typedef ConnectedComponentImageFilter2 Self;
   ...
   */
  itkTypeMacro(ConnectedComponentImageFilter2, ImageToImageFilter);
...
protected:
  ConnectedComponentImageFilter2() 
    {
    m_FullyConnected = false;
    }
  virtual ~ConnectedComponentImageFilter2() {}
  ConnectedComponentImageFilter2(const Self&) {}
...
private:
  ...
  void doRegion(EquivalencyTable::Pointer &eqTable, 
		OutputIteratorType &oit, 
		NeighborhoodIteratorType &nit, 
		OutputPixelType &maxLabel);

  // set up the neighborhood for faces
  void setFaceNeighborhood(NeighborhoodIteratorType &nit);
  // set up the neighborhood for the body
  void setNeighborhood(NeighborhoodIteratorType &nit);
};
  
} // end namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
#include "itkConnectedComponentImageFilter2.txx"
#endif
